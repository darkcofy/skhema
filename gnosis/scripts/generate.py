...
from scripts.client import find_repo_root, detect_client, resolve_workspace
from scripts.readiness import load_rules, evaluate_all
from scripts.parsers import count_yaml_entries
...
def main():
    ...
    rules_path = os.path.join(root, "gnosis", "rules", "artifacts.yaml")
